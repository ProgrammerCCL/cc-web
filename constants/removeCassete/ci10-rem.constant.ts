export type TMcStateRemoveCI10 =
  | "start"
  | "remove"
  | "Coin1"
  | "Coin2"
...
export const STATUS_MSG_CI10 = {
  start: "นำเงินออกจากกล่องเก็บเงิน (Model CI10B)",
  ...
  CoinIncasset1: "กรุณากรุณานำกล่องเหรียญออก",
...
export const REM_MC_CI10_COND = {
  start: noCondition,
  remove: {
    note: [
      "WaitForOpening COLLECTION DOOR",
      "Full CONTAINER_C4A_COUNTER",
